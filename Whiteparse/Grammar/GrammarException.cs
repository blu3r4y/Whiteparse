...
{
    /// <summary>
    /// Represents an error that occurs during grammar parsing or semantic resolution.
    /// </summary>
    public class GrammarException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GrammarException" /> class with a specified error message.
        /// </summary>
